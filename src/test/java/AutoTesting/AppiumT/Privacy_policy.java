...
public class Privacy_policy extends AppTest {
    private static final Logger logger = LogManager.getLogger(Privacy_policy.class);
    ...
    public void notifi() throws InterruptedException {
        ...
        try {
            ...
            logger.info("Scrolling to and clicking Privacy&policy");
            WebElement aboutUsBtn = driver.findElement(AppiumBy.androidUIAutomator(
                    "new UiSelector().description(\"Privacy Policy\")"));
            aboutUsBtn.click();
            ...
            for (String expected : expectedLines) {
                ...
                Assert.assertTrue(found, "Expected text not found in privacy and policy: " + expected);
            }

            logger.info("Successfully verified privacy and policy content");
